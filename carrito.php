...
<head>
    ...
    <!--Integrar boyon de Pagos -->
    <!-- Replace the "test" client-id value with your client-id -->
    <script src="https://www.paypal.com/sdk/js?client-id=ARob0pMWIjtys-zoEiucHlnQxZMTlbNQjWnCnQ83aFBIRtBRAOOiMjExIbgwH6aR2hbg1U8xUDmwHG-I&components=buttons&enable-funding=venmo,paylater" data-sdk-integration-source="integrationbuilder_sc"></script>
    <!--<script type="text/javascript" src="TiendaOnline/js/app.js"></script> -->
    <script type="text/javascript" src="../TiendaOnline/assets/js/prueba.js"></script>
...
<body>
                        ...
                        <div class="row justify-content-md-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <!--<button class="btn btn-block btn-success" onclick="solictarPedido('<?php echo $_SESSION['tokenStoragel']; ?>')">
                                    ...
                                    <img src="https://www.paypalobjects.com/webstatic/es_MX/mktg/logos-buttons/grey_btn-356x42.png" alt="PayPal Credit" />
                                </button>-->
                            </div>
                        </div>
                    </div>
    ...
    <script>
        //integrationbuilder_sc.Buttons().render("#paypal-button-container");
        paypal.Buttons({
            style: {
                color: 'blue',
                shape: 'pill',
